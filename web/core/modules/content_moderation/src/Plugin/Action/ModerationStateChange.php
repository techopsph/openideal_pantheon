...
class ModerationStateChange extends ConfigurableActionBase implements ContainerFactoryPluginInterface {
   ...
   *   The moderation info service.
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ModerationInformationInterface $moderation_info, EntityTypeManagerInterface $entity_type_manager, AccountInterface $current_user) {
  ...
  public function execute(ContentEntityInterface $entity = NULL) {
    ...
    $revision->setRevisionLogMessage('Changed moderation state to ' . $this->configuration['state']);
